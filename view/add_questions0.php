 ...
 <?php include('header.php'); ?>
  ...
  <div class="main-content">
    ...
    <div class="page-content">
                   ...
                   <input type="file" placeholder="Select Exam File" name="user_image" id="user_image" />
                   <button type="button" class="btn btn-primary waves-effect waves-light">
                         <i class="bx bx-plus font-size-16 align-middle mr-2"></i> Upload Multiple Questions
                     </button>
