...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2020 at 09:30 AM
...
INSERT INTO `admin_table` (`admin_id`, `firstname`, `lastname`, `phone_number`, `email_address`, `password`, `admin_created_on`, `picture`, `status`, `salt`) VALUES
(14, 'Ejigson', 'Ejigson', 8135777465, 'ejigsonpeter1@gmail.com', 'b708707e45a6be469b9794c4f46a646eec64c5ed628831b05ae8064e5fb49630', '2020-06-23 04:42:37', 'images.png', 'active', 'v7M8AE75ueZhnVvQTIvlf9fDDjdoEqtIw2UChh8v0Q612rGdQh1HWr5qFHQCgMb2qjoWBNA0oGFTPQFp3oxKDxCX02Mguk6Ed5Hu'),
...
INSERT INTO `agent` (`id`, `exam_id`, `exam_title`, `Agent_status`, `exam_status`) VALUES
(4, 1, 'Engish', 'Not Active', 'pending');
...
INSERT INTO `agent_logs` (`Id`, `exam_id`, `student_id`, `score`, `time`, `classification`, `Datetime`) VALUES
(1, 1, 5, 9, '15', 'no_threat', '2020-07-29 07:59:21');
...
INSERT INTO `alerts` (`id`, `exam_id`, `exam`, `fullname`, `offence`, `time`, `status`) VALUES
(6, 1, 'Engish', 'Ejigson  Lagun', 'Impersonation', '2020-07-29 00:48:38', 'Threat'),
...
INSERT INTO `exam_table` (`exam_id`, `admin_id`, `exam_title`, `exam_datetime`, `exam_duration`, `total_question`, `marks_per_right_answer`, `marks_per_wrong_answer`, `exam_created_on`, `exam_status`, `exam_code`) VALUES
(1, 14, 'Engish', '2020-06-23 06:20:00', '30', 30, '3', '1', '2020-06-23 07:18:58', 'pending', 'ff08e58174bb7ff130ab6fa5faf3dfd0');
...
INSERT INTO `question_table` (`question_id`, `online_exam_id`, `question_title`, `answer_option`, `option_1`, `option_2`, `option_3`, `option_4`) VALUES
(1, 1, '6W2fYU8fNIt5/h3TTBJnmomXnC0VVDfjL5Fe27w3Bw==', '2g==', '0WeRMkcCfpA=', '1WSeNA==', '0W6fIk4N', '3HCYIFQF'),
...
INSERT INTO `send_notification` (`n_id`, `title`, `exam_id`, `message`, `status`, `created_on`, `admin_id`) VALUES
(3, 'Attention ', 1, ' Your Exams Ends In 5 Minutes', 'sent', '2020-07-18 18:00:52', 14),
(4, 'Attention ', 1, ' Your Exams Ends In 5 Minutes', 'sent', '2020-07-18 18:56:39', 14),
...
INSERT INTO `student_table` (`student_id`, `firstname`, `lastname`, `middlename`, `email`, `password`, `phone`, `mother_maiden_name`, `user_image`, `favoritesport`, `petname`, `favoritefood`, `state`, `lga`, `dob`, `town`, `salt`, `user_created_on`) VALUES
(5, 'Ejigson', 'Lagun', 'Peter', 'ejigson@gmail.com', 'b8a550e2f8c60ed840aa3cab9d056517b26355aced5a59705e15122601b0db84', '12345678907', 'Nimat', '1.jpg', 'Football', 'Dog', 'Rice', 'Ebonyi', 'Ohaozara', '2020-07-29', 'Lokoja', 'u5Kw1PC9DFMP5OVFu6s8ZYgP2jSJYb8XI00Ls6hPjc5mg1HPZPZZ55YV7KPs9F5L3uDYQ1oGZTbAw8YWs74UIYbupWV854Kr6nxK', '2020-07-04 18:56:38');
...
INSERT INTO `tbl_email` (`id`, `email`) VALUES
(1, 'ejigsonpeter1@gmail.com'),
(2, 'ejigson@gmail.com'),
...
INSERT INTO `user_logs` (`Id`, `admin_id`, `fullname`, `access_level`, `status`, `datetime`) VALUES
(1, 14, 'Ejigson Ejigson', 'Administrator', 'active', '2020-06-24 07:26:42'),
...
--
ALTER TABLE `send_notification`
  MODIFY `n_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
